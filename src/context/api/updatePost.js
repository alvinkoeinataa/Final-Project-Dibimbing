...
export const UpdatePost = async (myImageUrl, myCaption, postId) => {
  try {
    const body = {
      imageUrl: myImageUrl,
      caption: myCaption,
    };
    const respon = await axios.post(`https://photo-sharing-api-bootcamp.do.dibimbing.id/api/v1/update-post/${postId}`, body, {
      headers: {
